...
def build_material(material, params, context, h4ek_base_path, addon_directory):
    ...
    main.node_tree = bpy.data.node_groups['srf_forerunner_lewis_lights_edge_glow']
